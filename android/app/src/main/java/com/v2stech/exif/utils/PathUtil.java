package com.v2stech.exif.utils;
...
public class PathUtil {
    public static @Nullable Uri compactUriFromFile(@NonNull final Context context, @NonNull final File file) {
        Uri result = null;
     ...
     */
    public static @Nullable String getFileProviderPath(@NonNull final Context context, @NonNull final Uri uri) {
